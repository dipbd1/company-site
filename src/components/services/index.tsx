                ...
                <div className="">
                    ...
                    <div className="grid grid-cols-1 gap-2 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:mt-4">
                        {data.services.map((services, index) => (
                            <a key={index} href="#"
                               className={`transition-all duration-1000 bg-gradient-to-r ${gradientColors[index % 3]}  hover:bg-blue-500  hover:shadow-xl m-2 p-4 relative z-40 group flex flex-col rounded-3xl overflow-hidden`}>
                                <div
